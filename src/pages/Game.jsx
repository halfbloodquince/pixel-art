...
export default function Game({ mult }) {
    ...
    if (paint && !chickenDinner) {
      ...
      if (current == gameState[Number(paintedSquare)].n) {
        event.target.setAttribute(
          "style",
          `background-color: ${paint}; color: ${paint}`
        );
      } else if (whiteText.includes(paint)) {
        event.target.setAttribute(
          "style",
          `background-color: ${paint}; color: white`
        );
      } else {
        event.target.setAttribute(
          "style",
          `background-color: ${paint}; color: black`
        );
      }
    }
  ...
  useEffect(() => {
    ...
    document.getElementById("current--colour").style.color = whiteText.includes(
      paint
    )
      ? "white"
      : "black";
    ...
    <div className="Game">
      ...
      <div className="svg--game--container">
        <div className="svg--game">
          ...
          >
            <g className="svg--paintbrush--icon">
            ...
            <path
              className="paint--brush--game svg--paintbrush--icon"
              d="M247 34C247 37.3137 244.314 40 241 40C237.686 40 235 37.3137 235 34C235 30.6863 237.686 28 241 28C244.314 28 247 30.6863 247 34Z"
              stroke="#BEF3F0"
              strokeWidth="2"
            />
            ...
            />
            <path
              className="paint--on--brush svg--paintbrush--icon"
        ...
        <div className="hidden">
          ...
          <div className="current--colour" id="current--colour">
          ...
          <ol className="rules--list">
            ...
            <li>
              If the multiplication matches the colour, it will disappear.
            </li>
        ...
        <div className="pixel--board">
          {numbers.map((number, i) => (
            <div
              onClick={(event) => handleSquareClick(event)}
              className={`pixel--square ${i}`}
              key={i}
            >
              {number} &times; {mult}
            </div>
          ...
          <div className="paints">
            {colours.map((obj) => (
              <div
                ...
                className="paintbox"
                style={
                  whiteText.includes(obj.colour)
                    ? { backgroundColor: obj.colour, color: "white" }
